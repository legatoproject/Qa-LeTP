...
APP_PATH = os.path.join(os.path.join(TEST_RESOURCES, "atomTryCreateStream"),
                        "atomTryCreateStream.adef")


# ==================================================================================================
# Test functions
# ==================================================================================================
def L_AtomicFile_Stream_0024(target, legato, app_leg, init_atomicFile):
    """
...
def L_AtomicFile_Stream_0025(target, legato, app_leg, init_atomicFile):
    """
...
def L_AtomicFile_Stream_0026(target, legato, app_leg, init_atomicFile):
    """
...
def L_AtomicFile_Stream_0027(target, legato, app_leg, init_atomicFile):
    """
    Purpose: Verify that resultPtr of le_atomFile_TryCreateStream returns
...
def L_AtomicFile_Stream_0028(target, legato, app_leg, init_atomicFile):
    """

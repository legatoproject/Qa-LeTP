...
def L_AtomicFile_Operation_0020(legato, init_atomicFile):
    ...
    Verification:
        This test case will mark as "failed" when
            1. le_atomFile_TryOpen doesn't return LE_NOT_FOUND
    This script will
        1. Make and install the test app
        2. Run the test app
        3. Check  "le_atomFile_TryOpen returns LE_NOT_FOUND ..." can be
...
def L_AtomicFile_Operation_0023(target, legato, init_atomicFile):
    ...
    Verification:
        This test case will mark as "failed" when
            1. The second process who calls le_atomFile_TryOpen

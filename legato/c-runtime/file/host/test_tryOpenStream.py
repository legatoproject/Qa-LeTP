""" @package atomicFileStreamTryOpenModule atomicFile Stream try open test
...
APP_PATH = os.path.join(os.path.join(TEST_RESOURCES, "atomTryOpenStream"),
                        "atomTryOpenStream.adef")


# ==================================================================================================
# Test functions
# ==================================================================================================
def L_AtomicFile_Stream_0019(target, legato, app_leg, init_atomicFile):
    """
...
def L_AtomicFile_Stream_0020(target, legato, app_leg, init_atomicFile):
    """
...
def L_AtomicFile_Stream_0021(target, legato, app_leg, init_atomicFile):
    """
...
def L_AtomicFile_Stream_0022(target, legato, app_leg, init_atomicFile):
    """
    Purpose: Verify that resultPtr of le_atomFile_TryOpenStream returns
...
def L_AtomicFile_Stream_0023(target, legato, app_leg, init_atomicFile):
    """

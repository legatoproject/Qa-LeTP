...
APP_PATH = os.path.join(os.path.join(TEST_RESOURCES, "atomCloseStream"),
                        "atomCloseStream.adef")


# ==================================================================================================
# Test functions
# ==================================================================================================
def L_AtomicFile_Stream_0029(target, legato, app_leg, init_atomicFile):
    """
    ...
    test_descriptions = ["openStreamWrtFlockOK", "tryOpenStreamWrtFlockOK",
                         "createStreamWrtFlockOK", "tryCreateStreamWrtFlockOK"]
...
def L_AtomicFile_Stream_0030(target, legato, app_leg, init_atomicFile):
    """

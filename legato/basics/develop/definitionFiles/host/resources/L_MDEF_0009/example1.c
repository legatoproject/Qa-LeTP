...
static char *param11 = "PARAM1";
module_param(param11, charp, S_IRUGO);
MODULE_PARM_DESC(param11, "First module parameter");

static char *param12 = "PARAM2";
module_param(param12, charp, S_IRUGO);
MODULE_PARM_DESC(param12, "Second module parameter");

static int __init example_init(void)
{
   pr_info("Executing %s(), param1='%s' param2='%s'.\n", __func__, param11, param12);
   return 0;
}

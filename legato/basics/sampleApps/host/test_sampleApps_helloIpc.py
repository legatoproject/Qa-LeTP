""" @package helloIpcAppsModule HelloIpc Sample apps test
...
# Test functions
# ==================================================================================================
def L_SampleApps_HelloIpc_0001(legato, installapp_cleanup):
    """
    This script will
    ...
    assert legato.find_in_target_log(text_log1) is True, \
                                    ("[FAILED] Could not find out the log")
    swilog.info("[PASSED] Found client request string")

    assert legato.find_in_target_log(text_log2) is True, \
                                    ("[FAILED] Could not find out the log")
